(function (global) {
  ...
  var STR = {
    zh: {
      ...
      my_island_hint: '点击查看你所在岛的 CE/FATE', set_show_chips: '显示当前 FATE/CE 胶囊', set_treasure_guide: '启用魔法罐寻宝指引', set_radar: '启用宝箱与胡萝卜雷达', chips_hidden: '已隐藏（可在设置中重新打开）',
      radar_title: '雷达', radar_bronze: '铜宝箱', radar_silver: '银宝箱', radar_carrot: '胡萝卜',
    ...
    en: {
      ...
      my_island_hint: 'Click to see your island CE/FATE', set_show_chips: 'Show active FATE/CE chips', set_treasure_guide: 'Enable Magic Pot treasure guidance', set_radar: 'Enable coffer and carrot radar', chips_hidden: 'Hidden (re-enable in settings)',
      radar_title: 'Radar', radar_bronze: 'Bronze coffer', radar_silver: 'Silver coffer', radar_carrot: 'Carrot',
    ...
    ja: {
      ...
      my_island_hint: 'クリックで自分の島のCE/FATE', set_show_chips: '現在のFATE/CEを表示', set_treasure_guide: 'マジックポット宝探しを有効化', set_radar: '宝箱・ニンジンレーダーを有効化', chips_hidden: '非表示にしました（設定で再表示）',
      radar_title: 'レーダー', radar_bronze: '銅の宝箱', radar_silver: '銀の宝箱', radar_carrot: 'ニンジン',
