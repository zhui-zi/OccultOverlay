(function (global) {
  ...
  var STR = {
    zh: {
      ...
      my_island_hint: '点击查看你所在岛的 CE/FATE', set_show_chips: '显示当前 FATE/CE 胶囊', set_treasure_guide: '启用魔法罐寻宝指引', chips_hidden: '已隐藏（可在设置中重新打开）',
    ...
    en: {
      ...
      my_island_hint: 'Click to see your island CE/FATE', set_show_chips: 'Show active FATE/CE chips', set_treasure_guide: 'Enable Magic Pot treasure guidance', chips_hidden: 'Hidden (re-enable in settings)',
    ...
    ja: {
      ...
      my_island_hint: 'クリックで自分の島のCE/FATE', set_show_chips: '現在のFATE/CEを表示', set_treasure_guide: 'マジックポット宝探しを有効化', chips_hidden: '非表示にしました（設定で再表示）',
