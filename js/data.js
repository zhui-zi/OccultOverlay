...
(function (global) {
  ...
  OC.CES = {
    ...
    // North Horn. Per-event Phantom Dispeller mappings are not available yet.
    49: { name: { zh: '四颚斧花—提蔛', en: 'Many Mouths to Feed', ja: '四つ顎の魔樹「ペレキュス」' }, drops: [], spawn_type: true, monster: { zh: '提蔛', en: 'Pelekys', ja: 'ペレキュス' } },
    50: { name: { zh: '魔女复制体—卡洛菲斯提莉二重身', en: 'Doubled Trouble', ja: '魔女の複製体「カロフィステリ・ダブル」' }, drops: [51988], spawn_type: true, monster: { zh: '新月黑卫', en: 'Crescent Blackguard', ja: 'クレセント・ブラックガード' } },
    ...
    53: { name: { zh: '暗红尸骸—赤龙', en: 'Cursed Resurgence', ja: '暗紅の屍竜「ルブルムドラゴン」' }, drops: [51986], spawn_type: true, monster: { zh: '新月大角牛', en: 'Crescent Big Horn', ja: 'クレセント・ビッグホーン' } },
    54: { name: { zh: '暴食咒鬼—阿尔戈尔', en: 'Imbalanced Diet', ja: '大食の呪鬼「アルゴル」' }, drops: [51981], spawn_type: false },
    55: { name: { zh: '残暴的母蜘蛛—新月阿剌克涅', en: 'Web of Terror', ja: '猟奇の母蜘蛛「クレセント・アルケニー」' }, drops: [], spawn_type: true, monster: { zh: '新月地狱犬', en: 'Crescent Hellhound', ja: 'クレセント・ヘルハウンド' } },
    ...
    61: { name: { zh: '孤岛的绑架犯—诱拐魔', en: 'Lost on the Wind', ja: '絶島の誘拐者「アブダクター」' }, drops: [51985], spawn_type: true, monster: { zh: '新月幽灵', en: 'Crescent Wraith', ja: 'クレセント・レイス' } },
