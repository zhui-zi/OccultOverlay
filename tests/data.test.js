...
assert.equal(i18nSandbox.OC.i18n.t('alert_pot_minutes'), '提前分钟');
...
assert.equal(i18nSandbox.OC.i18n.t('set_radar_pinned_help'), 'Keep the radar panel visible when the map is collapsed.');
...
assert.equal(i18nSandbox.OC.i18n.t('alert_pot_minutes'), '出現前の分数');
